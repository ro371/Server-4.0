...
public class DaiquirivenenoItem extends ServerModElements.ModElement {
	@ObjectHolder("server:daiquiriveneno")
	public static final Item block = null;
	public DaiquirivenenoItem(ServerModElements instance) {
		super(instance, 58);
	}
