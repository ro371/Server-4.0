...
public class MediumpizzavenenoItem extends ServerModElements.ModElement {
	@ObjectHolder("server:mediumpizzaveneno")
	public static final Item block = null;
	public MediumpizzavenenoItem(ServerModElements instance) {
		super(instance, 69);
	}
