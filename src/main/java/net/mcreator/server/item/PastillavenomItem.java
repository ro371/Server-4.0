...
public class PastillavenomItem extends ServerModElements.ModElement {
	@ObjectHolder("server:pastillavenom")
	public static final Item block = null;
	public PastillavenomItem(ServerModElements instance) {
		super(instance, 190);
	}
