...
public class VasodeaguaflyItem extends ServerModElements.ModElement {
	@ObjectHolder("server:vasodeaguafly")
	public static final Item block = null;
	public VasodeaguaflyItem(ServerModElements instance) {
		super(instance, 200);
	}
