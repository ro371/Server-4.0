...
public class SpagettivenenoItem extends ServerModElements.ModElement {
	@ObjectHolder("server:spagettiveneno")
	public static final Item block = null;
	public SpagettivenenoItem(ServerModElements instance) {
		super(instance, 62);
	}
