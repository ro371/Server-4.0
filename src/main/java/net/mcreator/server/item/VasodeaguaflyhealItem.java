...
public class VasodeaguaflyhealItem extends ServerModElements.ModElement {
	@ObjectHolder("server:vasodeaguaflyheal")
	public static final Item block = null;
	public VasodeaguaflyhealItem(ServerModElements instance) {
		super(instance, 206);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("vasodeaguaflyheal");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				VasodeaguaflyhealFoodEatenProcedure.executeProcedure($_dependencies);
			}
