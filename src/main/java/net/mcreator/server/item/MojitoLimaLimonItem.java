...
public class MojitoLimaLimonItem extends ServerModElements.ModElement {
	@ObjectHolder("server:mojitolimalimon")
	public static final Item block = null;
	public MojitoLimaLimonItem(ServerModElements instance) {
		super(instance, 24);
	}
