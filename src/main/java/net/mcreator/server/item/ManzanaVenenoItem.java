...
public class ManzanaVenenoItem extends ServerModElements.ModElement {
	@ObjectHolder("server:manzana_veneno")
	public static final Item block = null;
	public ManzanaVenenoItem(ServerModElements instance) {
		super(instance, 229);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("manzana_veneno");
		}
