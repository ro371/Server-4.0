...
public class Itemtaken7Procedure extends ServerModElements.ModElement {
	public Itemtaken7Procedure(ServerModElements instance) {
		super(instance, 130);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ServerMod.LOGGER.warn("Failed to load dependency entity for procedure Itemtaken7!");
			return;
		}
		...
		if ((((entity.getCapability(ServerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (((entity.getPersistentData().getDouble("coin1")) >= 3)) {
				...
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(GreenDaydiskItem.block, (int) (1));
