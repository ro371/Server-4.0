...
public class BankWhileThisGUIIsOpenTickProcedure extends ServerModElements.ModElement {
	public BankWhileThisGUIIsOpenTickProcedure(ServerModElements instance) {
		super(instance, 81);
	}
