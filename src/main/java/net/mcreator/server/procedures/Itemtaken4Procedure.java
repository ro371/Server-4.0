...
public class Itemtaken4Procedure extends ServerModElements.ModElement {
	public Itemtaken4Procedure(ServerModElements instance) {
		super(instance, 123);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ServerMod.LOGGER.warn("Failed to load dependency entity for procedure Itemtaken4!");
			return;
		}
