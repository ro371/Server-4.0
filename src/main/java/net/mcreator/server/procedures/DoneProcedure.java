	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if ((7 == ((entity.getCapability(ServerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				if ((new ItemStack(Items.COD, (int) (1)).getItem() == (new Object() {
					...
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(MisionfishItem.block, (int) (1));
				...
				if (((new Object() {
					...
					if (((new Object() {
						...
						if (((new Object() {
							...
							if (((((new ItemStack(Blocks.COBBLESTONE, (int) (1)).getItem() == (new Object() {
								public ItemStack getItemStack(int sltid) {
									Entity _ent = entity;
									if (_ent instanceof ServerPlayerEntity) {
										Container _current = ((ServerPlayerEntity) _ent).openContainer;
							...
							}.getItemStack((int) (1))).getItem())) && (new ItemStack(Blocks.COBBLESTONE, (int) (1)).getItem() == (new Object() {
								public ItemStack getItemStack(int sltid) {
									Entity _ent = entity;
									if (_ent instanceof ServerPlayerEntity) {
										Container _current = ((ServerPlayerEntity) _ent).openContainer;
							...
							}.getItemStack((int) (2))).getItem())) && (new ItemStack(Blocks.COBBLESTONE, (int) (1)).getItem() == (new Object() {
								public ItemStack getItemStack(int sltid) {
									Entity _ent = entity;
									if (_ent instanceof ServerPlayerEntity) {
										Container _current = ((ServerPlayerEntity) _ent).openContainer;
								...
								if (entity instanceof PlayerEntity) {
									ItemStack _stktoremove = new ItemStack(MisionstoneItem.block, (int) (1));
									((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
											((PlayerEntity) entity).container.func_234641_j_());
								}
								if (entity instanceof PlayerEntity)
