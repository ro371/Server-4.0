...
public class ShopWhileThisGUIIsOpenTickProcedure extends ServerModElements.ModElement {
	public ShopWhileThisGUIIsOpenTickProcedure(ServerModElements instance) {
		super(instance, 114);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ShopWhileThisGUIIsOpenTick!");
			return;
		}
