...
public class Itemtaken8Procedure extends ServerModElements.ModElement {
	public Itemtaken8Procedure(ServerModElements instance) {
		super(instance, 130);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ServerMod.LOGGER.warn("Failed to load dependency entity for procedure Itemtaken8!");
			return;
		}
		...
		if ((((entity.getCapability(ServerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (((entity.getPersistentData().getDouble("coin1")) >= 2)) {
				...
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(RammsteindiskItem.block, (int) (1));
