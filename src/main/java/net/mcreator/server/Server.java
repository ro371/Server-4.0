 ...
 *
 *    Keep the ElementsServer object in this class and all calls to this object
...
public class Server {
	...
	public static final String VERSION = "4.0.3.1";
	...
	public ElementsServer elements = new ElementsServer();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsServer.GuiHandler());
