...
public class BuyguiGui extends ServerModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BuyguiGui(ServerModElements instance) {
		super(instance, 159);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("buygui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, BuyguiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
				...
				this.addSlot(new Slot(inv, si, 0 + 8 + si * 18, 0 + 142));
			{
				...
				BuyguiThisGUIIsOpenedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onContainerClosed(PlayerEntity playerIn) {
			super.onContainerClosed(playerIn);
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				BuyguiThisGUIIsClosedProcedure.executeProcedure($_dependencies);
			}
		...
		if (slotID == 5 && changeType == 1) {
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				TradedoneProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
