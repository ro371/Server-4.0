...
public class AltoPoliciaPotion extends ServerModElements.ModElement {
	@ObjectHolder("server:altopolicia")
	public static final Effect potion = null;
	@ObjectHolder("server:altopolicia")
	public static final Potion potionType = null;
	public AltoPoliciaPotion(ServerModElements instance) {
		super(instance, 40);
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			super(EffectType.HARMFUL, -52225);
			setRegistryName("altopolicia");
			potionIcon = new ResourceLocation("server:textures/alto_policia.png");
		}

		@Override
		public String getName() {
			return "effect.altopolicia";
		}
		...
		public void affectEntity(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
			...
			double z = entity.getPosZ();
			{
				...
				AltoPoliciaPotionStartedappliedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void removeAttributesModifiersFromEntity(LivingEntity entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				AltoPoliciaPotionExpiresProcedure.executeProcedure($_dependencies);
			}
		}
